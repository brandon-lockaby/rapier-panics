...
export declare enum SpringModel {
    Disabled = 0,
    VelocityBased = 1,
    AccelerationBased = 2,
    ForceBased = 3
...
export declare class UnitJoint extends Joint {
    /**
...
export declare class PrismaticJoint extends UnitJoint {
}
export declare class BallJoint extends Joint {
    configureMotorModel(model: SpringModel): void;
...
export declare class RevoluteJoint extends UnitJoint {
}
