...
export interface InitOutput {
  ...
  readonly rawintegrationparameters_jointErp: (a: number) => number;
  readonly rawintegrationparameters_warmstartCoeff: (a: number) => number;
  ...
  readonly rawintegrationparameters_allowedAngularError: (a: number) => number;
  readonly rawintegrationparameters_maxLinearCorrection: (a: number) => number;
  readonly rawintegrationparameters_maxAngularCorrection: (a: number) => number;
  readonly rawintegrationparameters_maxVelocityIterations: (a: number) => number;
  readonly rawintegrationparameters_maxPositionIterations: (a: number) => number;
  ...
  readonly rawintegrationparameters_set_jointErp: (a: number, b: number) => void;
  readonly rawintegrationparameters_set_warmstartCoeff: (a: number, b: number) => void;
  ...
  readonly rawintegrationparameters_set_allowedAngularError: (a: number, b: number) => void;
  readonly rawintegrationparameters_set_maxLinearCorrection: (a: number, b: number) => void;
  readonly rawintegrationparameters_set_maxAngularCorrection: (a: number, b: number) => void;
  readonly rawintegrationparameters_set_maxVelocityIterations: (a: number, b: number) => void;
  readonly rawintegrationparameters_set_maxPositionIterations: (a: number, b: number) => void;
  ...
  readonly rawjointset_jointBodyHandle1: (a: number, b: number) => number;
  readonly rawjointset_jointBodyHandle2: (a: number, b: number) => number;
  readonly rawjointset_jointType: (a: number, b: number) => number;
  readonly rawjointset_jointFrameX1: (a: number, b: number) => number;
  readonly rawjointset_jointFrameX2: (a: number, b: number) => number;
  readonly rawjointset_jointAnchor1: (a: number, b: number) => number;
  readonly rawjointset_jointAnchor2: (a: number, b: number) => number;
  readonly rawjointset_jointAxis1: (a: number, b: number) => number;
  readonly rawjointset_jointAxis2: (a: number, b: number) => number;
  readonly rawjointset_jointLimitsEnabled: (a: number, b: number) => number;
  readonly rawjointset_jointLimitsMin: (a: number, b: number) => number;
  readonly rawjointset_jointLimitsMax: (a: number, b: number) => number;
  readonly rawjointset_jointConfigureMotorModel: (a: number, b: number, c: number) => void;
  readonly rawjointset_jointConfigureBallMotorVelocity: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly rawjointset_jointConfigureBallMotorPosition: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly rawjointset_jointConfigureBallMotor: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
  readonly rawjointset_jointConfigureUnitMotorVelocity: (a: number, b: number, c: number, d: number) => void;
  readonly rawjointset_jointConfigureUnitMotorPosition: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly rawjointset_jointConfigureUnitMotor: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly __wbg_rawjointparams_free: (a: number) => void;
  readonly rawjointparams_ball: (a: number, b: number) => number;
  readonly rawjointparams_prismatic: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
  readonly rawjointparams_fixed: (a: number, b: number, c: number, d: number) => number;
  readonly rawjointparams_revolute: (a: number, b: number, c: number, d: number) => number;
  readonly __wbg_rawjointset_free: (a: number) => void;
  readonly rawjointset_new: () => number;
  readonly rawjointset_createJoint: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly rawjointset_remove: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly rawjointset_len: (a: number) => number;
  readonly rawjointset_contains: (a: number, b: number) => number;
  readonly rawjointset_forEachJointHandle: (a: number, b: number) => void;
  ...
  readonly rawrigidbodyset_rbRestrictRotations: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  ...
  readonly rawrigidbodyset_rbIsStatic: (a: number, b: number) => number;
  ...
  readonly rawrigidbodyset_rbApplyForce: (a: number, b: number, c: number, d: number) => void;
  readonly rawrigidbodyset_rbApplyImpulse: (a: number, b: number, c: number, d: number) => void;
  readonly rawrigidbodyset_rbApplyTorque: (a: number, b: number, c: number, d: number) => void;
  readonly rawrigidbodyset_rbApplyTorqueImpulse: (a: number, b: number, c: number, d: number) => void;
  readonly rawrigidbodyset_rbApplyForceAtPoint: (a: number, b: number, c: number, d: number, e: number) => void;
  ...
  readonly rawrigidbodyset_remove: (a: number, b: number, c: number, d: number, e: number) => void;
  ...
  readonly rawcolliderset_coParent: (a: number, b: number) => number;
  readonly rawcolliderset_coFriction: (a: number, b: number) => number;
  readonly rawcolliderset_coDensity: (a: number, b: number, c: number) => void;
  ...
  readonly raweventqueue_drainContactEvents: (a: number, b: number) => void;
  readonly raweventqueue_drainIntersectionEvents: (a: number, b: number) => void;
  ...
  readonly rawphysicspipeline_step: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
  readonly rawphysicspipeline_stepWithEvents: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => void;
  ...
  readonly rawquerypipeline_castRay: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
  readonly rawquerypipeline_castRayAndGetNormal: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
  readonly rawquerypipeline_intersectionsWithRay: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly rawquerypipeline_intersectionWithShape: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly rawquerypipeline_projectPoint: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly rawquerypipeline_intersectionsWithPoint: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly rawquerypipeline_castShape: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  readonly rawquerypipeline_intersectionsWithShape: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  ...
  readonly rawdeserializedworld_takeJoints: (a: number) => number;
  readonly __wbg_rawserializationpipeline_free: (a: number) => void;
  readonly rawserializationpipeline_new: () => number;
  readonly rawserializationpipeline_serializeAll: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
